 ...
 - [x] - publish
 - [x]  - fix the bug when using from docker:
[2025-10-24 22:51:50.930][TEST_APP][POST][/this/is/a/test]: File created {
path: '/../../../../../../app/data/TEST_APP/this/is/a/test',
data: '{"foo":"bar"}'
}
 - [x] - create the client that can use this and a template or doc or example
 - [x] - add build numbers to the app and build id into the log
 - [ ] - truncate the logs of the info. Otherwise logs will start be huge
